// https://gist.github.com/laralove143/06a4767572809cc309cd15ed6ef5d4de

use std::fmt::{self, Display};

use twilight_model::{
    channel::message::{sticker::StickerFormatType, Sticker},
    guild::{Emoji, Guild, Member, Role},
    id::marker::{
        ApplicationMarker, EmojiMarker, GuildMarker, OauthTeamMarker, RoleMarker,
        StickerBannerAssetMarker, StickerMarker, UserMarker,
    },
    id::Id,
...
pub trait EmojiImage<'a> {
    ...
    fn image(
        ...
        always_static: bool,
        size: ImageSize,
    ) -> EndpointFormat<'a, Id<EmojiMarker>>;
}
...
pub trait GuildImage<'a> {
    ...
    fn icon(
        ...
        always_static: bool,
        size: ImageSize,
    ) -> Option<EndpointFormat<'a, Id<GuildMarker>>>;
...
impl<'a> GuildImage<'a> for Guild {
    fn icon(
        ...
        Some(EndpointFormat {
            ...
            id: self.id,
            hash: Some(hash),
            extension: extension.into(hash.is_animated(), always_static),
            size,
        })
    }
...
pub trait UserImage<'a> {
    ...
    fn banner(
        ...
        always_static: bool,
        size: ImageSize,
    ) -> Option<EndpointFormat<'a, Id<UserMarker>>>;
...
pub trait MemberImage<'a> {
    ...
    fn avatar(
        ...
        always_static: bool,
        size: ImageSize,
    ) -> Option<LongEndpointFormat<'a, Id<GuildMarker>, Id<UserMarker>>>;
}
...
pub trait ApplicationImage<'a> {
    ...
    fn icon(
        ...
        extension: Extension,
        size: ImageSize,
    ) -> Option<EndpointFormat<'a, Id<ApplicationMarker>>>;
...
pub trait StickerPackImage<'a> {
    ...
    fn banner(
        ...
        extension: Extension,
        size: ImageSize,
    ) -> EndpointFormat<'a, Id<StickerBannerAssetMarker>>;
}

impl<'a> StickerPackImage<'a> for Id<StickerBannerAssetMarker> {
    fn banner(
        &self,
        extension: Extension,
        size: ImageSize,
...
pub trait TeamImage<'a> {
    ...
    fn icon(
        ...
        extension: Extension,
        size: ImageSize,
    ) -> Option<EndpointFormat<'a, Id<OauthTeamMarker>>>;
}
...
pub trait StickerImage<'a> {
    ...
    fn image(&'a self) -> EndpointFormat<'a, Id<StickerMarker>>;
}
...
pub trait RoleImage<'a> {
    ...
    fn icon(
        ...
        always_static: bool,
        size: ImageSize,
    ) -> Option<EndpointFormat<'a, Id<RoleMarker>>>;
}
